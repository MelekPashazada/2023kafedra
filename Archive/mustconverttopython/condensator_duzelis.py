...
if trunc((taut*j)/10)==k2:
    ...
    print((taut*j),' ',(m[0,j]),' ',(p[0,j]),' ',(p[1,j]),' ',(p[2,j]),' ',(p[3,j]),' ',(p[4,j]),' ',(p[5,j]),' ',(p[6,j]),' ',(p[7,j]),' ',(p[8,j]),' ',(p[9,j]),' ',(p[10,j]),' ',(p[11,j]),' ',(p[12,j]),' ',(p[13,j]),' ',(p[14,j]),' ',(p[15,j]),' ',(sig[0,j]),' ',(sig[1,j]),' ',(sig[2,j]),' ',(sig[3,j]),' ',sig[4,j],' ',sig[5,j],' ',sig[6,j],' ',sig[7,j],' ',sig[8,j],' ',sig[9,j],' ',sig[10,j],' ',(sig[11,j]),' ',(sig[12,j]),' ',(sig[13,j]),' ',(sig[14,j]),' ',sig[15,j],' ',(q/gk),' ',gk)

    print("\n\n")


    print(f,(taut*j),' ',' ',(m[0,j]),' ',(p[0,j]),' ',(p[1,j]),' ',(p[2,j]),' ',(p[3,j]),' ',(p[4,j]),' ',(p[5,j]),' ',(p[6,j]),' ',(p[7,j]),' ',(p[8,j]),' ',(p[9,j]),' ',(p[10,j]),' ',(p[11,j]),' ',(p[12,j]),' ',(p[13,j]),' ',(p[14,j]),' ',(p[15,j]),' ',(sig[0,j]),' ',(sig[1,j]),' ',(sig[2,j]),' ',(sig[3,j]),' ',sig[4,j],' ',sig[5,j],' ',sig[6,j],' ',sig[7,j],' ',sig[8,j],' ',sig[9,j],' ',sig[10,j],' ',(sig[11,j]),' ',(sig[12,j]),' ',(sig[13,j]),' ',(sig[14,j]),' ',sig[15,j],' ',(m[0,j]),' ',m[n,j],' ',(q/gk),' ',gk)
